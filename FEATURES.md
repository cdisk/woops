...
| `[~]` | 运维文档 | CI 已有 [`docs/woopsctl-gitlab-ci.md`](docs/woopsctl-gitlab-ci.md)；仍缺 GitLab OAuth / Agent 安装运维文 |
...
| 部署 | `deploy/docker-compose.yml`（含 guacd profile）；Gateway 自签名 TLS：`deploy/gen-gateway-tls.sh` |
